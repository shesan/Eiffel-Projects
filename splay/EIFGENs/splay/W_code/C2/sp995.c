/*
 * Code for class SPLAY_BAD_DELETE_OTHER_NODES_UNCHANGED
 */
...
extern void F995_7861(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SPLAY_BAD_DELETE_OTHER_NODES_UNCHANGED}.delete */
void F995_7861 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 994, Current, 7, 1, 14141);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	ui4_1 = (EIF_INTEGER_32) (ti4_3 * ((EIF_INTEGER_32) 10L));
