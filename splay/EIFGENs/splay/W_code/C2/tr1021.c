/*
 * Code for class TREE_NODE_BAD_COUNT_CORRECT_RESULT [INTEGER_32, INTEGER_32]
 */
...
extern EIF_TYPED_VALUE F1021_7915(EIF_REFERENCE);
...
/* {TREE_NODE_BAD_COUNT_CORRECT_RESULT}.count */
EIF_TYPED_VALUE F1021_7915 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1020, Current, 2, 0, 14258);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1020, Current, 14258);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
