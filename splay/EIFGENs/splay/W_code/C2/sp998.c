/*
 * Code for class SPLAY_BAD_INSERT_HAS_INSERTED_NODE
 */
...
extern void F998_7866(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {SPLAY_BAD_INSERT_HAS_INSERTED_NODE}.insert */
void F998_7866 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 997, Current, 4, 2, 14146);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14146);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(4);
	if ((EIF_BOOLEAN)(loc2 == ((EIF_INTEGER_32) 999L))) {
		RTHOOK(5);
