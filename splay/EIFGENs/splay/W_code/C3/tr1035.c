/*
 * Code for class TREE_NODE_BAD_INSERT_RIGHT_KEEP_PARENT_REF [INTEGER_32, INTEGER_32]
 */
...
extern void F1035_7917(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TREE_NODE_BAD_INSERT_RIGHT_KEEP_PARENT_REF}.insert_right */
void F1035_7917 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1034, Current, 4, 1, 14260);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1034, Current, 14260);
...
body:;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5554, 0xF800040A, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
