/*
 * Code for class SPLAY_BAD_RELINK_CASE_OF_RELINK_THE_LEFT_CHILD [G#1, G#2]
 */
...
extern void F1038_7874(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {SPLAY_BAD_RELINK_CASE_OF_RELINK_THE_LEFT_CHILD}.relink */
void F1038_7874 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1037, Current, 0, 3, 14154);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1037, Current, 14154);
	{
