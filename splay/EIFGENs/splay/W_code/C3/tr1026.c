/*
 * Code for class TREE_NODE_BAD_INSERT_LEFT_KEEP_PARENT_REF [INTEGER_32, INTEGER_32]
 */
...
extern void F1026_7919(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TREE_NODE_BAD_INSERT_LEFT_KEEP_PARENT_REF}.insert_left */
void F1026_7919 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1025, Current, 4, 1, 14262);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5553, 0xF8000401, 0); /* left */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
