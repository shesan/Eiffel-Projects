/*
 * Code for class TREE_NODE_BAD_INSERT_RIGHT_IS_ASSIGNED [INTEGER_32, INTEGER_32]
 */
...
extern void F1040_7916(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TREE_NODE_BAD_INSERT_RIGHT_IS_ASSIGNED}.insert_right */
void F1040_7916 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1039, Current, 4, 1, 14259);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1039, Current, 14259);
	RTCC(arg1, 1039, l_feature_name, 1, eif_new_type(dftype, 1), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5554, 0xF800040F, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
