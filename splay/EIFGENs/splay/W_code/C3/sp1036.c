/*
 * Code for class SPLAY_BAD_RELINK_CHILDS_PARENT_IS_LINKED [G#1, G#2]
 */
...
extern void F1036_7872(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {SPLAY_BAD_RELINK_CHILDS_PARENT_IS_LINKED}.relink */
void F1036_7872 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1035, Current, 0, 3, 14152);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1035, Current, 14152);
	{
