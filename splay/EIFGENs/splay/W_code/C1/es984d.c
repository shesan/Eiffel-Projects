...
static const struct desc_info desc_984[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 13894, 32},
	{EIF_NON_GENERIC(0x0197 /*203*/), 13895, 33},
	{EIF_GENERIC(egt_14_984), 13896, 0},
	{EIF_GENERIC(egt_15_984), 13897, 8},
	{EIF_GENERIC(egt_16_984), 13898, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13899, 36},
	{EIF_GENERIC(egt_17_984), 13900, 24},
};
void Init984(void)
{
	IDSC(desc_984, 0, 983);
