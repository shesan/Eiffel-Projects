...
static const EIF_TYPE_INDEX egt_17_985 [] = {0xFF01,254,0xFF01,0xFFF9,0,186,0xFFFF};
...
static const struct desc_info desc_985[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 13894, 40},
	{EIF_NON_GENERIC(0x0197 /*203*/), 13895, 41},
	{EIF_GENERIC(egt_14_985), 13896, 0},
	{EIF_GENERIC(egt_15_985), 13897, 8},
	{EIF_GENERIC(egt_16_985), 13898, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13899, 44},
	{EIF_GENERIC(egt_17_985), 13900, 24},
	{EIF_GENERIC(NULL), 13902, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_985), 13905, 32},
};
void Init985(void)
{
	IDSC(desc_985, 0, 984);
	...
	IDSC(desc_985 + 91, 408, 984);
	IDSC(desc_985 + 103, 407, 984);
}
