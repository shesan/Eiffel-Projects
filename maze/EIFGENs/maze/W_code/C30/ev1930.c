...
extern EIF_TYPED_VALUE F1930_24501(EIF_REFERENCE);
extern void F1930_24502(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1930_24503(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1930_24504(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1930_24505(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1930_24506(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1930_24507(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1930_24508(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1930_24509(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1930_24510(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1930_24511_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1930_24511(EIF_REFERENCE);
extern void EIF_Minit1930(void);
extern EIF_REFERENCE _A1930_1824();
...
EIF_TYPED_VALUE F1930_24501 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
void F1930_24502 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1929, Current, 0, 1, 31182);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1929, Current, 31182);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 20014, 0x04000000, 1); /* is_homogeneous */
	*(EIF_BOOLEAN *)(Current + RTWA(20014, dtype)) = (EIF_BOOLEAN) arg1;
	RTHOOK(2);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(20014, dtype));
...
void F1930_24503 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1929, Current, 0, 1, 31183);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1929, Current, 31183);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(20013, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(3);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16482, dtype))(Current)).it_i4);
	ui4_1 = ti4_1;
	ur1 = RTCCL(Current);
...
void F1930_24504 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1929, Current, 0, 1, 31184);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1929, Current, 31184);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("positive_value", EX_PRE);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(20012, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(3);
...
void F1930_24505 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1929, Current, 0, 3, 31185);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1929, Current, 31185);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
body:;
	...
	ub1 = (EIF_BOOLEAN) 1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(20016, dtype))(Current, ui4_1x, ub1x);
	RTHOOK(4);
	ui4_1 = arg1;
	ui4_2 = arg2;
	ui4_3 = arg3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(18928, 1928))(Current, ui4_1x, ui4_2x, ui4_3x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
void F1930_24506 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1929, Current, 0, 5, 31186);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1929, Current, 31186);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1930_24507 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1929, Current, 16, 2, 31187);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1929, Current, 31187);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(ti4_1 != ((EIF_INTEGER_32) 0L))) {
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19999, dtype))(Current)).it_i4);
		loc7 = (EIF_INTEGER_32) (EIF_INTEGER_32) ((EIF_INTEGER_32) (arg1 - (EIF_INTEGER_32) (((EIF_INTEGER_32) 2L) * loc10)) - ti4_1);
		RTHOOK(9);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19190, dtype))(Current)).it_b);
		if (tb1) {
			RTHOOK(10);
			RTDBGAL(16, 0xF800010E, 0, 0); /* loc16 */
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(20009, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			loc16 = (EIF_REFERENCE) RTCCL(tr1);
			RTHOOK(11);
			if ((EIF_BOOLEAN)(loc16 == NULL)) {
				RTHOOK(12);
				RTDBGAL(16, 0xF800010E, 0, 0); /* loc16 */
				tr1 = RTLNSMART(RTWCT(20009, dtype, dftype).id);
				...
				loc16 = (EIF_REFERENCE) RTCCL(tr1);
				RTHOOK(13);
				RTDBGAA(Current, dtype, 20009, 0xF800010E, 0); /* reversed_sizing_agents */
				tr1 = RTCCL(loc16);
				RTAR(Current, tr1);
				*(EIF_REFERENCE *)(Current + RTWA(20009, dtype)) = (EIF_REFERENCE) tr1;
			} else {
				RTHOOK(14);
		...
		if (tb1) {
			...
			for (;;) {
				...
				if (tb2) {
					...
					ui4_1 = loc5;
					ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(20007, dtype))(Current, ui4_1x)).it_i4);
					...
					if ((EIF_BOOLEAN)(loc16 != NULL)) {
						RTHOOK(27);
						{
							EIF_TYPE_INDEX typarr0[] = {0xFFF9,7,186,0xFF01,0,0xFF01,1924,218,218,218,218,203,0xFFFF};
							EIF_TYPE typres0;
							typarr0[4] = dftype;
						...
						
						{
							...
							tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1930_1824, (EIF_POINTER)(0),20010, 0, 0, 1, -1, tr1, 0);
						}
						ur1 = RTCCL(tr2);
						...
						ui4_4 = ti4_2;
						ub1 = arg2;
						(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(20010, dtype))(Current, ur1x, ui4_1x, ui4_2x, ui4_3x, ui4_4x, ub1x);
					}
					RTHOOK(29);
					RTDBGAL(6, 0x10000000, 1, 0); /* loc6 */
			...
			ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(20002, dtype));
			...
			for (;;) {
				...
				loc3 = (EIF_REFERENCE) RTCCL(tr1);
				RTHOOK(49);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16714, "is_show_requested", loc3))(loc3)).it_b);
				if (tb3) {
					RTHOOK(50);
					...
					if ((EIF_BOOLEAN)(ti4_1 != loc15)) {
						...
						ui4_1 = loc5;
						ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(20007, dtype))(Current, ui4_1x)).it_i4);
...
void F1930_24508 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1929, Current, 5, 1, 31188);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1929, Current, 31188);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 20000, 0x10000000, 1); /* childvisible_nb */
	*(EIF_INTEGER_32 *)(Current + RTWA(20000, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(3);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(20011, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		RTHOOK(15);
		RTDBGAA(Current, dtype, 20000, 0x10000000, 1); /* childvisible_nb */
		*(EIF_INTEGER_32 *)(Current + RTWA(20000, dtype)) = (EIF_INTEGER_32) loc5;
		RTHOOK(16);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(20001, dtype))(Current);
	}
	RTHOOK(17);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(20012, dtype));
...
void F1930_24509 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1929, Current, 5, 1, 31189);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1929, Current, 31189);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(20000, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		if (tb1) {
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(20000, dtype)) = (EIF_INTEGER_32) loc5;
			...
			for (;;) {
				...
				loc2 = (EIF_REFERENCE) RTCCL(tr1);
				RTHOOK(20);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16714, "is_show_requested", loc2))(loc2)).it_b);
				if (tb3) {
					RTHOOK(21);
					RTDBGAL(5, 0x10000000, 1, 0); /* loc5 */
					loc5++;
			...
			RTHOOK(24);
			RTDBGAA(Current, dtype, 20015, 0x10000000, 1); /* children_width */
			*(EIF_INTEGER_32 *)(Current + RTWA(20015, dtype)) = (EIF_INTEGER_32) loc4;
			RTHOOK(25);
			RTDBGAA(Current, dtype, 20000, 0x10000000, 1); /* childvisible_nb */
			*(EIF_INTEGER_32 *)(Current + RTWA(20000, dtype)) = (EIF_INTEGER_32) loc5;
			RTHOOK(26);
		...
		RTHOOK(30);
		RTDBGAA(Current, dtype, 20015, 0x10000000, 1); /* children_width */
		*(EIF_INTEGER_32 *)(Current + RTWA(20015, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
		RTHOOK(31);
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(20012, dtype));
...
void F1930_24510 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1929, Current, 6, 1, 31190);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1929, Current, 31190);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(20000, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		if (tb1) {
			...
			RTHOOK(15);
			RTDBGAA(Current, dtype, 20000, 0x10000000, 1); /* childvisible_nb */
			*(EIF_INTEGER_32 *)(Current + RTWA(20000, dtype)) = (EIF_INTEGER_32) loc6;
			RTHOOK(16);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(20001, dtype))(Current);
			RTHOOK(17);
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19999, dtype))(Current)).it_i4);
			...
			ti4_3 = *(EIF_INTEGER_32 *)(Current + RTWA(20012, dtype));
			...
			RTHOOK(26);
			RTDBGAA(Current, dtype, 20015, 0x10000000, 1); /* children_width */
			*(EIF_INTEGER_32 *)(Current + RTWA(20015, dtype)) = (EIF_INTEGER_32) loc5;
			RTHOOK(27);
			RTDBGAA(Current, dtype, 20000, 0x10000000, 1); /* childvisible_nb */
			*(EIF_INTEGER_32 *)(Current + RTWA(20000, dtype)) = (EIF_INTEGER_32) loc6;
			RTHOOK(28);
...
static EIF_TYPED_VALUE F1930_24511_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1929, Current, 0, 0, 31191);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1929, Current, 31191);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1930_24511 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(16044, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1930_24511_body (Current)).it_r;
