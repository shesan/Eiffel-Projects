...
extern void F1923_24172(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1923_24173(EIF_REFERENCE);
extern void F1923_24174(EIF_REFERENCE);
extern void F1923_24175(EIF_REFERENCE);
extern void F1923_24176(EIF_REFERENCE);
static EIF_TYPED_VALUE F1923_24177_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1923_24177(EIF_REFERENCE);
...
void F1923_24172 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1922, Current, 0, 0, 30912);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 30912);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16039, 1919))(Current);
	RTHOOK(2);
...
EIF_TYPED_VALUE F1923_24173 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1923_24174 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1922, Current, 1, 0, 30914);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 30914);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		ui4_1 = ti4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(19247, "check_button", loc1))(loc1, ui4_1x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
void F1923_24175 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1922, Current, 1, 0, 30915);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 30915);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 19820, 0x04000000, 1); /* is_selected */
	*(EIF_BOOLEAN *)(Current + RTWA(19820, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	...
	if (EIF_TEST(loc1)) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(10877, dtype));
		ui4_1 = ti4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(19248, "uncheck_button", loc1))(loc1, ui4_1x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
void F1923_24176 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1922, Current, 2, 0, 30916);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 30916);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(loc2 != NULL)) {
		...
		for (;;) {
			...
			if (!RTCEQ(tr1, Current)) {
				...
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				RTNHOOK(7,1);
				(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(19818, "disable_select", tr1))(tr1);
			}
			RTHOOK(8);
...
static EIF_TYPED_VALUE F1923_24177_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1922, Current, 0, 0, 30917);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1922, Current, 30917);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1923_24177 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(16044, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1923_24177_body (Current)).it_r;
