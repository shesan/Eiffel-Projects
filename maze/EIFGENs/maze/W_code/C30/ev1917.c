...
extern void F1917_24092(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1917_24093_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1917_24093(EIF_REFERENCE);
...
void F1917_24092 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1916, Current, 0, 1, 30840);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 30840);
...
static EIF_TYPED_VALUE F1917_24093_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1916, Current, 0, 0, 30841);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1916, Current, 30841);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1917_24093 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(16044, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1917_24093_body (Current)).it_r;
