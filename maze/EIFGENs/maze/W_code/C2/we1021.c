...
extern void F1021_9678(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1021_9678 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1020, Current, 0, 1, 15981);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 1020, l_feature_name, 1, eif_new_type(1807, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7463, 0xF800070F, 0); /* message_information */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
