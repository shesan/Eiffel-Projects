...
extern EIF_TYPED_VALUE F1014_9304(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1014_9304 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1013, Current, 0, 1, 15608);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1013, Current, 15608);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7091, dtype))(Current)).it_i4);
