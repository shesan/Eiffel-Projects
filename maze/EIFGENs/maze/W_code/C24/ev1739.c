...
extern EIF_TYPED_VALUE F1739_20252(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1739_20253(EIF_REFERENCE);
extern void F1739_20261(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1739_20262_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1739_20262(EIF_REFERENCE);
extern void F1739_26056(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1739_20252 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(16966,Dtype(Current)));
	return r;
}


/* {EV_GAUGE_I}.proportion */
EIF_TYPED_VALUE F1739_20253 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1738, Current, 2, 0, 27246);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1738, Current, 27246);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1739_20261 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1738, Current, 2, 1, 27248);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1738, Current, 27248);
	RTIV(Current, RTAL);
...
static EIF_TYPED_VALUE F1739_20262_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1738, Current, 0, 0, 27249);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1738, Current, 27249);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1739_20262 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(16044, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1739_20262_body (Current)).it_r;
...
void F1739_26056 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1738, Current, 0, 26055);
	RTSA(dtype);
	RTME(dtype, 0);
