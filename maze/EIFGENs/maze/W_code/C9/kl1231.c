...
extern EIF_TYPED_VALUE F1231_12949(EIF_REFERENCE);
...
RTOID (F1231_12949)
EIF_TYPED_VALUE F1231_12949 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1230, Current, 0, 0, 19207);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1230, Current, 19207);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
