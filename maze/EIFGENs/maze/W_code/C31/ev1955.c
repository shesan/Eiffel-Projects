...
extern EIF_TYPED_VALUE F1955_25216(EIF_REFERENCE);
static EIF_TYPED_VALUE F1955_25217_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1955_25217(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1955_25216 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1954, Current, 0, 0, 31883);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1954, Current, 31883);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ti4_5 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7879, dtype))(Current)).it_i4);
	ti4_6 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10373, dtype))(Current)).it_i4);
	ti4_7 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10372, dtype))(Current)).it_i4);
...
static EIF_TYPED_VALUE F1955_25217_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1954, Current, 0, 0, 31884);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1954, Current, 31884);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1955_25217 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(16044, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1955_25217_body (Current)).it_r;
