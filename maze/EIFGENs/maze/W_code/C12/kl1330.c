...
extern EIF_TYPED_VALUE F1330_14240(EIF_REFERENCE);
...
RTOID (F1330_14240)
EIF_TYPED_VALUE F1330_14240 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1329, Current, 0, 0, 20473);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1329, Current, 20473);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
