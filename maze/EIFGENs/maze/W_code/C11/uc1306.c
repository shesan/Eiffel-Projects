...
extern EIF_TYPED_VALUE F1306_13936(EIF_REFERENCE);
...
RTOID (F1306_13936)
EIF_TYPED_VALUE F1306_13936 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1305, Current, 0, 0, 20186);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1305, Current, 20186);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
