...
extern EIF_TYPED_VALUE F1088_10585(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1088_10585 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1087, Current, 0, 0, 16938);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1087, Current, 16938);
	RTIV(Current, RTAL);
