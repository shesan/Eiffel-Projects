...
static const EIF_TYPE_INDEX egt_13_1079 [] = {0xFF01,1378,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1079 [] = {0xFF01,1364,0xFFFF};
...
static const struct desc_info desc_1079[] = {
	...
	{EIF_GENERIC(egt_13_1079), 16837, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1079), 16838, 0xFFFFFFFF},
};
void Init1079(void)
{
	IDSC(desc_1079, 0, 1078);
	IDSC(desc_1079 + 1, 1, 1078);
	IDSC(desc_1079 + 32, 1256, 1078);
}
