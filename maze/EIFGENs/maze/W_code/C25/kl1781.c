...
extern EIF_TYPED_VALUE F1781_20647(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1781_20647 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1780, Current, 0, 0, 27546);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1780, Current, 27546);
	RTIV(Current, RTAL);
	RTHOOK(1);
