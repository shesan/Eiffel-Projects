...
extern EIF_TYPED_VALUE F1792_20953(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1792_20954(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1792_20955(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1792_20956(EIF_REFERENCE);
...
RTOID (F1792_20953)
EIF_TYPED_VALUE F1792_20953 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1791, Current, 0, 0, 27818);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1791, Current, 27818);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(17804, "is_current_file_system", Result))(Result)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
RTOID (F1792_20954)
EIF_TYPED_VALUE F1792_20954 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1791, Current, 0, 0, 27819);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1791, Current, 27819);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800071E, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1822, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(17803, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
RTOID (F1792_20955)
EIF_TYPED_VALUE F1792_20955 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1791, Current, 0, 0, 27820);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1791, Current, 27820);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800071E, 0,0); /* Result */
...
RTOID (F1792_20956)
EIF_TYPED_VALUE F1792_20956 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1791, Current, 0, 0, 27817);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1791, Current, 27817);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (20953,F1792_20953)
	RTOTS (20954,F1792_20954)
	RTOTS (20955,F1792_20955)
	RTOTS (20956,F1792_20956)
}
