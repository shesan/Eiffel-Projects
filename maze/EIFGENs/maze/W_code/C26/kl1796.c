...
extern void F1796_21035(EIF_REFERENCE);
extern void F1796_21036(EIF_REFERENCE);
...
void F1796_21035 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1795, Current, 0, 0, 27880);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1795, Current, 27880);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1796_21036 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1795, Current, 0, 0, 27881);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1795, Current, 27881);
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(17593, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
