...
extern EIF_TYPED_VALUE F1812_21181(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1812_21181 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1811, Current, 0, 0, 28020);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1811, Current, 28020);
	RTIV(Current, RTAL);
	RTHOOK(1);
