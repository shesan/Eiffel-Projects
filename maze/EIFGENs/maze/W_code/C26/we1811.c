...
extern EIF_TYPED_VALUE F1811_21179(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1811_21180(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1811_21179 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1810, Current, 0, 0, 28018);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1810, Current, 28018);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1811_21180 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1810, Current, 0, 0, 28019);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1810, Current, 28019);
	RTIV(Current, RTAL);
	RTHOOK(1);
