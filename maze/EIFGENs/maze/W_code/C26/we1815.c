...
extern EIF_TYPED_VALUE F1815_21203(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1815_21203 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1814, Current, 0, 0, 28042);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1814, Current, 28042);
	RTIV(Current, RTAL);
	RTHOOK(1);
