...
extern EIF_TYPED_VALUE F2055_3467(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2055_3468(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2055_3469(EIF_REFERENCE);
...
/* {SORTED_LIST}.min */
EIF_TYPED_VALUE F2055_3467 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2054, Current, 0, 0, 20835);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2054, Current, 20835);
	RTIV(Current, RTAL);
...
/* {SORTED_LIST}.max */
EIF_TYPED_VALUE F2055_3468 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2054, Current, 0, 0, 20836);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2054, Current, 20836);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_empty", EX_PRE);
...
/* {SORTED_LIST}.median */
EIF_TYPED_VALUE F2055_3469 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2054, Current, 0, 0, 20837);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2054, Current, 20837);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_empty", EX_PRE);
