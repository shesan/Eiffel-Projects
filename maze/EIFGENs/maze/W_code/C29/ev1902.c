...
extern EIF_TYPED_VALUE F1902_23592(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1902_23593(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1902_23592 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1901, Current, 0, 0, 30350);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1901, Current, 30350);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1902_23593 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1901, Current, 0, 0, 30351);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1901, Current, 30351);
	RTIV(Current, RTAL);
	RTHOOK(1);
