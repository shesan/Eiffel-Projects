...
extern EIF_TYPED_VALUE F1899_23556(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1899_23556 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1898, Current, 0, 1, 30316);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1898, Current, 30316);
	RTIV(Current, RTAL);
	RTHOOK(1);
