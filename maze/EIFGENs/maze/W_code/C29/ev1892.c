...
extern EIF_TYPED_VALUE F1892_23341(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1892_23342(EIF_REFERENCE);
extern void F1892_23343(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1892_23344(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1892_23345(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1892_23341 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1891, Current, 1, 0, 30107);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1891, Current, 30107);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1892_23342 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1891, Current, 1, 0, 30108);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1891, Current, 30108);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
void F1892_23343 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1891, Current, 0, 1, 30104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1891, Current, 30104);
	RTCC(arg1, 1891, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
body:;
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		if (tb1) {
			RTHOOK(4);
			RTDBGAA(Current, dtype, 19410, 0xF80000EE, 0); /* internal_text */
...
EIF_TYPED_VALUE F1892_23344 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
RTOID (F1892_23345)
EIF_TYPED_VALUE F1892_23345 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1892_23345);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1891, Current, 0, 0, 30106);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1891, Current, 30106);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(18969, 1890))(Current)).it_i4);
