...
extern EIF_TYPED_VALUE F1044_10034(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1044_10035(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1044_10036(EIF_REFERENCE);
extern void F1044_10037(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1044_10038(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1044_10034 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1044_10035 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1043, Current, 1, 0, 16392);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1043, Current, 16392);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1044_10037 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1043, Current, 2, 1, 16393);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1043, Current, 16393);
	RTCC(arg1, 1043, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7819, 0xF800011C, 0); /* items */
	{
	...
	*(EIF_REFERENCE *)(Current + RTWA(7819, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7818, 0xF80000E8, 0); /* error_string */
	tr1 = RTLNSMART(RTWCT(7818, dtype, Dftype(Current)).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(4643, Dtype(tr1)))(tr1);
	RTNHOOK(2,1);
	tr1 = RTCCL(tr1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7818, dtype)) = (EIF_REFERENCE) tr1;
	...
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 7817, 0x04000000, 1); /* error */
	...
	if (RTAL & CK_ENSURE) {
		...
		tb2 = '\01';
		tb3 = *(EIF_BOOLEAN *)(Current + RTWA(7817, dtype));
		if (tb3) {
			tb3 = '\0';
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7819, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(16,1);
...
void F1044_10038 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1043, Current, 1, 0, 16394);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1043, Current, 16394);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7819, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
