...
static const struct desc_info desc_1025[] = {
	...
	{EIF_NON_GENERIC(0x01B5 /*218*/), 16029, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 16030, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 16031, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0197 /*203*/), 16032, 0xFFFFFFFF},
};
void Init1025(void)
{
	IDSC(desc_1025, 0, 1024);
	IDSC(desc_1025 + 1, 1, 1024);
	IDSC(desc_1025 + 32, 633, 1024);
}
