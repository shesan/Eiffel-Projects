...
extern EIF_TYPED_VALUE F1041_10006(EIF_REFERENCE);
extern void F1041_25954(EIF_REFERENCE, int);
...
/* {MAZE_ACCESS}.m */
RTOID (F1041_10006)
EIF_TYPED_VALUE F1041_10006 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1040, Current, 0, 0, 16360);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1041_25954 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1040, Current, 0, 25953);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
