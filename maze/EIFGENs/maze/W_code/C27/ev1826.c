...
extern void F1826_21440(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1826_21442(EIF_REFERENCE);
extern void F1826_21443(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F1826_21440 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1825, Current, 2, 0, 28231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1825, Current, 28231);
	RTIV(Current, RTAL);
...
body:;
	...
	if (EIF_TEST(loc2)) {
		RTHOOK(4);
		RTDBGAA(Current, dtype, 17889, 0x04000000, 1); /* last_pixmap_loading_had_error */
		*(EIF_BOOLEAN *)(Current + RTWA(17889, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
		RTHOOK(5);
		...
		if (tb1) {
			...
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(17890, dtype))(Current, up1x, up2x, up3x);
		} else {
			RTHOOK(7);
		...
		RTHOOK(9);
		RTDBGAA(Current, dtype, 17889, 0x04000000, 1); /* last_pixmap_loading_had_error */
		*(EIF_BOOLEAN *)(Current + RTWA(17889, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	}
	RTHOOK(10);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(17889, dtype));
	if (tb1) {
		RTHOOK(11);
...
EIF_TYPED_VALUE F1826_21442 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(17889,Dtype(Current)));
	return r;
}


/* {EV_PIXMAP_IMP_LOADER}.c_ev_load_pixmap */
void F1826_21443 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_p
	...
	RTEAA(l_feature_name, 1825, Current, 0, 3, 28233);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1825, Current, 28233);
