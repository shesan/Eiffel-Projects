...
extern EIF_TYPED_VALUE F1603_18562(EIF_REFERENCE);
extern void F1603_18563(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1603_18562 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1603_18563 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1602, Current, 0, 0, 25964);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1602, Current, 25964);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15166, 0xF80006B5, 0); /* implementation */
