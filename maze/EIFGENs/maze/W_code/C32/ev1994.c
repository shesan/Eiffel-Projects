...
extern EIF_TYPED_VALUE F1994_19583(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1994_19584(EIF_REFERENCE);
extern void F1994_19585(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1994_19586(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1994_19583 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1993, Current, 2, 1, 26832);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 26832);
	RTIV(Current, RTAL);
...
body:;
	...
	if (EIF_TEST(loc1)) {
		...
		loc2 = RTCCL(tr1);
		loc2 = RTRV(RTWCT(16375, dtype, Dftype(Current)),loc2);
		tb1 = EIF_TEST(loc2);
	}
	if (tb1) {
		RTCK0;
...
EIF_TYPED_VALUE F1994_19584 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1993, Current, 0, 0, 26833);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 26833);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1994_19585 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1993, Current, 1, 2, 26834);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 26834);
	RTCC(arg1, 1993, l_feature_name, 1, RTWCT(16375, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
...
void F1994_19586 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1993, Current, 0, 1, 26835);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 26835);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
