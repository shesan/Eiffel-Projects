...
extern EIF_TYPED_VALUE F1666_19198(EIF_REFERENCE);
static EIF_TYPED_VALUE F1666_19217_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1666_19217(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1666_19198 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1665, Current, 2, 0, 26575);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1665, Current, 26575);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80000E8, 0,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16097, dtype))(Current)).it_i4);
	RTNHOOK(1,1);
	tr1 = c_outi(ti4_1);
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4821, "append", Result))(Result, ur1x);
	RTHOOK(18);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16104, dtype))(Current)).it_b);
	RTNHOOK(18,1);
...
static EIF_TYPED_VALUE F1666_19217_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1665, Current, 0, 0, 26576);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1665, Current, 26576);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1666_19217 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(16044, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1666_19217_body (Current)).it_r;
