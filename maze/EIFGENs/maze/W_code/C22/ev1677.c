...
static EIF_TYPED_VALUE F1677_19428_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1677_19428(EIF_REFERENCE);
extern void F1677_26043(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1677_19428_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1676, Current, 0, 0, 26696);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1676, Current, 26696);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1677_19428 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(16044, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1677_19428_body (Current)).it_r;
...
void F1677_26043 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1676, Current, 0, 26042);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("not_has_text_implies_text_empty", Current);
	tb1 = '\01';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16264, dtype))(Current)).it_b);
	if ((EIF_BOOLEAN) !tb2) {
