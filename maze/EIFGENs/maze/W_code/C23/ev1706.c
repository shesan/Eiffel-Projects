...
extern EIF_TYPED_VALUE F1706_19860(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1706_19860 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1705, Current, 0, 0, 27035);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1705, Current, 27035);
	RTIV(Current, RTAL);
	RTHOOK(1);
