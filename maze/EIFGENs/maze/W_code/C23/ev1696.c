...
extern EIF_TYPED_VALUE F1696_19821(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1696_19822(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1696_19823(EIF_REFERENCE);
extern void F1696_19824(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1696_19825(EIF_REFERENCE);
extern void F1696_19826(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1696_19821 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1695, Current, 2, 0, 27010);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1695, Current, 27010);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1696_19822 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1695, Current, 3, 0, 27011);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1695, Current, 27011);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16601, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc3 = RTCCL(tr1);
	if (EIF_TEST(loc3)) {
		...
		for (;;) {
			...
			RTNHOOK(5,1);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16597, "is_selected", tr1))(tr1)).it_b);
			if (tb2) {
				RTHOOK(6);
				RTDBGAL(2, 0xF800062B, 0, 0); /* loc2 */
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", loc3))(loc3)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				RTNHOOK(6,1);
				tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16044, "interface", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F1696_19823 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1696_19824 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1695, Current, 2, 1, 27013);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1695, Current, 27013);
	RTCC(arg1, 1695, l_feature_name, 1, RTWCT(16601, dtype, dftype), 0x00);
	RTIV(Current, RTAL);
...
void F1696_19825 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1695, Current, 1, 0, 27014);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1695, Current, 27014);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 16601, 0xF80003A1, 0); /* radio_group */
	*(EIF_REFERENCE *)(Current + RTWA(16601, dtype)) = (EIF_REFERENCE) NULL;
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
...
void F1696_19826 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1695, Current, 0, 1, 27015);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1695, Current, 27015);
	RTCC(arg1, 1695, l_feature_name, 1, RTWCT(16601, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16601, 0xF80003A1, 0); /* radio_group */
	tr1 = RTCCL(arg1);
