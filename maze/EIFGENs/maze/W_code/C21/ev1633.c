...
extern EIF_TYPED_VALUE F1633_18940(EIF_REFERENCE);
extern void F1633_18941(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1633_18940 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1633_18941 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1632, Current, 0, 0, 26344);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1632, Current, 26344);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15166, 0xF80006D5, 0); /* implementation */
