...
extern EIF_TYPED_VALUE F1638_18964(EIF_REFERENCE);
extern void F1638_18965(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1638_18964 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1638_18965 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1637, Current, 0, 0, 26367);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1637, Current, 26367);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15166, 0xF80006D8, 0); /* implementation */
