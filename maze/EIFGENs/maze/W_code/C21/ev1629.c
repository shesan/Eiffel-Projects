...
extern EIF_TYPED_VALUE F1629_18923(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1629_18924(EIF_REFERENCE);
extern void F1629_18925(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1629_18923 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1628, Current, 0, 0, 26327);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1628, Current, 26327);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15171, 1622))(Current)).it_b);
	if (tb2) {
...
EIF_TYPED_VALUE F1629_18924 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1629_18925 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1628, Current, 0, 0, 26329);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1628, Current, 26329);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15166, 0xF80006D0, 0); /* implementation */
