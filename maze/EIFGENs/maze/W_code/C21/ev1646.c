...
extern EIF_TYPED_VALUE F1646_18998(EIF_REFERENCE);
extern void F1646_18999(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1646_18998 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1646_18999 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1645, Current, 0, 0, 26401);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1645, Current, 26401);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15166, 0xF80006DE, 0); /* implementation */
