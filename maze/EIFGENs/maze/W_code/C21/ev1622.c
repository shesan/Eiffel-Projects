...
extern EIF_TYPED_VALUE F1622_18814(EIF_REFERENCE);
extern void F1622_18815(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1622_18814 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1622_18815 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1621, Current, 0, 0, 26216);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1621, Current, 26216);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15166, 0xF80006C6, 0); /* implementation */
