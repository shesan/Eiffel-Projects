...
extern void F1643_18984(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1643_18985(EIF_REFERENCE);
extern void F1643_18986(EIF_REFERENCE);
extern void F1643_18987(EIF_REFERENCE);
extern void F1643_18988(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1643_18989(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1643_18990(EIF_REFERENCE);
extern void F1643_18991(EIF_REFERENCE);
...
void F1643_18984 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1642, Current, 0, 2, 26386);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1642, Current, 26386);
	RTCC(arg1, 1642, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1642, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1643_18985 (EIF_REFERENCE Current)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 1642, Current, 1, 0, 26387);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1642, Current, 26387);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15462, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
void F1643_18986 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1642, Current, 0, 0, 26388);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1642, Current, 26388);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1643_18987 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1642, Current, 0, 0, 26389);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1642, Current, 26389);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
void F1643_18988 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1642, Current, 0, 0, 26390);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1642, Current, 26390);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1643_18989 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1642, Current, 0, 0, 26391);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1642, Current, 26391);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = '\0';
	tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15171, 1633))(Current)).it_b);
	if (tb3) {
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15171, 1588))(Current)).it_b);
		tb2 = tb3;
	}
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15171, 1596))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F1643_18990 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1643_18991 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1642, Current, 0, 0, 26393);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1642, Current, 26393);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 15166, 0xF80006DB, 0); /* implementation */
