...
static const EIF_TYPE_INDEX egt_13_972 [] = {0xFF01,989,0xFFFF};
...
static const struct desc_info desc_972[] = {
	...
	{EIF_GENERIC(egt_13_972), 15130, 0},
	{EIF_NON_GENERIC(0x0793 /*969*/), 15131, 0xFFFFFFFF},
};
void Init972(void)
{
	IDSC(desc_972, 0, 971);
	IDSC(desc_972 + 1, 1, 971);
	IDSC(desc_972 + 32, 1308, 971);
}
