...
extern void F972_8828(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F972_8829(EIF_REFERENCE);
extern EIF_TYPED_VALUE F972_8830(EIF_REFERENCE);
...
void F972_8828 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 971, Current, 0, 1, 15129);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(971, Current, 15129);
	RTCC(arg1, 971, l_feature_name, 1, eif_new_type(989, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6619, 0xF80003DD, 0); /* guid */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(6619, dtype)) = (EIF_REFERENCE) tr1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("set", EX_POST);
...
EIF_TYPED_VALUE F972_8829 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F972_8830 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 971, Current, 2, 0, 15131);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
