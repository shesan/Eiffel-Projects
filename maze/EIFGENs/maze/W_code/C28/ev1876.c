...
extern void F1876_23048(EIF_REFERENCE);
extern void F1876_23049(EIF_REFERENCE);
extern void F1876_23050(EIF_REFERENCE);
...
void F1876_23048 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_6 ui4_6x.it_i4
	...
	RTEAA(l_feature_name, 1875, Current, 0, 0, 29814);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1875, Current, 29814);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1876_23049 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1875, Current, 1, 0, 29815);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1875, Current, 29815);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(2,2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9429, "theme_changed_actions", tr2))(tr2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(2,3);
	ur1 = NULL;
...
void F1876_23050 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1875, Current, 2, 0, 29816);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1875, Current, 29816);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(19105, 1871))(Current);
	RTHOOK(2);
	RTDBGAL(1, 0xF8000623, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1571, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(32, Dtype(tr1)))(tr1);
	...
	RTHOOK(4);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9431, "system_color_change_actions", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
	ur1 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3112, "call", tr1))(tr1, ur1x);
	RTVI(Current, RTAL);
