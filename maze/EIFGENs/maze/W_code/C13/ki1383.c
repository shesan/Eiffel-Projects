...
extern EIF_TYPED_VALUE F1383_14696(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1383_14697(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1383_14696 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1382, Current, 0, 0, 21346);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1382, Current, 21346);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1383_14697 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1382, Current, 0, 1, 21347);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1382, Current, 21347);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	...
	RTNHOOK(1,1);
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8545, "maximum_byte_code", tr1))(tr1)).it_i4);
