...
void F2042_4189 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 2041, Current, 0, 0, 20595);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20595);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2041, Current, 0, 1, 20596);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20596);
	RTIV(Current, RTAL);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2041, Current, 1, 2, 20599);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20599);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2041, Current, 1, 2, 20600);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20600);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("item_index_valid", EX_PRE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2041, Current, 0, 1, 20601);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2041, Current, 20601);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
