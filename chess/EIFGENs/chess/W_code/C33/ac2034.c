...
void F2034_4189 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 2033, Current, 0, 0, 20587);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2033, Current, 20587);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2033, Current, 0, 1, 20588);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2033, Current, 20588);
	RTIV(Current, RTAL);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2033, Current, 1, 2, 20591);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2033, Current, 20591);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2033, Current, 1, 2, 20592);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2033, Current, 20592);
	RTCC(arg1, 2033, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2033, Current, 0, 1, 20593);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2033, Current, 20593);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
