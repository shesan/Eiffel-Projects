...
extern EIF_TYPED_VALUE F1640_18597(EIF_REFERENCE);
extern void F1640_18598(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1640_18597 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1640_18598 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1639, Current, 0, 0, 25266);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1639, Current, 25266);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14811, 0xF80006DA, 0); /* implementation */
