...
extern EIF_TYPED_VALUE F1804_20690(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1804_20691(EIF_REFERENCE);
extern void F1804_20692(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1804_20690 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1804_20691 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1804_20692 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1803, Current, 0, 0, 26741);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1803, Current, 26741);
	RTIV(Current, RTAL);
