...
extern EIF_TYPED_VALUE F1784_20270(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1784_20270 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1783, Current, 0, 0, 26379);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1783, Current, 26379);
	RTIV(Current, RTAL);
	RTHOOK(1);
