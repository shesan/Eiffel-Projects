...
extern void F1799_20658(EIF_REFERENCE);
extern void F1799_20659(EIF_REFERENCE);
...
void F1799_20658 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1798, Current, 0, 0, 26713);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1798, Current, 26713);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1799_20659 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1798, Current, 0, 0, 26714);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1798, Current, 26714);
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(17229, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
