...
extern EIF_TYPED_VALUE F1304_13851(EIF_REFERENCE);
...
RTOID (F1304_13851)
EIF_TYPED_VALUE F1304_13851 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1303, Current, 0, 0, 20075);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
