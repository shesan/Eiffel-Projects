...
extern EIF_TYPED_VALUE F2003_12601(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2003_12602(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2003_12604(EIF_REFERENCE);
extern void F2003_12609(EIF_REFERENCE);
extern void F2003_12610(EIF_REFERENCE);
...
EIF_TYPED_VALUE F2003_12601 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 2002, Current, 2, 3, 18869);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2002, Current, 18869);
	{
...
body:;
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			RTHOOK(12);
			tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10372, dtype))(Current)).it_c1);
			uc1 = tc1;
			ui4_1 = loc1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(9336, "put", arg1))(arg1, uc1x, ui4_1x);
			RTHOOK(13);
			RTDBGAL(1, 0x10000000, 1, 0); /* loc1 */
			loc1++;
		} else {
...
EIF_TYPED_VALUE F2003_12602 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2002, Current, 0, 0, 18870);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2002, Current, 18870);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2003_12604 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2002, Current, 0, 0, 18871);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2002, Current, 18871);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
void F2003_12609 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2002, Current, 0, 0, 18872);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2002, Current, 18872);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F2003_12610 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2002, Current, 0, 0, 18873);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2002, Current, 18873);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
