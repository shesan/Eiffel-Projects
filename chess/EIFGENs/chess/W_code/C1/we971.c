...
extern void F971_8808(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F971_8809(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_8810(EIF_REFERENCE);
...
void F971_8808 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 970, Current, 0, 1, 15109);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(970, Current, 15109);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6599, 0xF80003DF, 0); /* guid */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F971_8809 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F971_8810 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 970, Current, 2, 0, 15111);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(970, Current, 15111);
	RTIV(Current, RTAL);
	RTHOOK(1);
