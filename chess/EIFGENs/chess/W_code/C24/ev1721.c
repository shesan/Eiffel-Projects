...
extern EIF_TYPED_VALUE F1721_19669(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1721_19670(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1721_19671(EIF_REFERENCE);
static EIF_TYPED_VALUE F1721_19672_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1721_19672(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1721_19669 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1720, Current, 0, 0, 26049);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1720, Current, 26049);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,3);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(14554, "y", tr1))(tr1)).it_i4);
...
EIF_TYPED_VALUE F1721_19670 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1720, Current, 0, 0, 26050);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1720, Current, 26050);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	...
	RTNHOOK(1,2);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15072, "height", tr2))(tr2)).it_i4);
...
EIF_TYPED_VALUE F1721_19671 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1720, Current, 0, 0, 26051);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1720, Current, 26051);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
static EIF_TYPED_VALUE F1721_19672_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1721_19672 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15689, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1721_19672_body (Current)).it_r;
