...
extern EIF_TYPED_VALUE F1720_19665(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1720_19666(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1720_19667(EIF_REFERENCE);
static EIF_TYPED_VALUE F1720_19668_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1720_19668(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1720_19665 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1719, Current, 0, 0, 26045);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1719, Current, 26045);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15164, "pointer_position", tr2))(tr2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,3);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(14552, "x", tr1))(tr1)).it_i4);
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16204, dtype))(Current)).it_i4);
...
EIF_TYPED_VALUE F1720_19666 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1719, Current, 0, 0, 26046);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1719, Current, 26046);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	...
	RTNHOOK(1,2);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15071, "width", tr2))(tr2)).it_i4);
...
EIF_TYPED_VALUE F1720_19667 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1719, Current, 0, 0, 26047);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1719, Current, 26047);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
static EIF_TYPED_VALUE F1720_19668_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1719, Current, 0, 0, 26048);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1719, Current, 26048);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1720_19668 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15689, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1720_19668_body (Current)).it_r;
