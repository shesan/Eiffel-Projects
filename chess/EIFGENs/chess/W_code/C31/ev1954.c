...
extern void F1954_24751(EIF_REFERENCE);
extern void F1954_24752(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1954_24753(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1954_24754_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1954_24754(EIF_REFERENCE);
...
void F1954_24751 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1953, Current, 0, 0, 30631);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1954_24752 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_4 ui4_4x.it_i4
	...
	RTEAA(l_feature_name, 1953, Current, 4, 2, 30632);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1953, Current, 30632);
	RTCC(arg1, 1953, l_feature_name, 1, eif_new_type(1405, 0x01), 0x01);
	RTCC(arg2, 1953, l_feature_name, 2, eif_new_type(1499, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(19827, dtype))(Current, ur1x, ur2x, ui4_1x);
	RTHOOK(14);
...
void F1954_24753 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_4 ui4_4x.it_i4
	...
	RTCC(arg1, 1953, l_feature_name, 1, eif_new_type(1405, 0x01), 0x01);
	RTCC(arg2, 1953, l_feature_name, 2, eif_new_type(1411, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg2);
...
static EIF_TYPED_VALUE F1954_24754_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1953, Current, 0, 0, 30634);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1953, Current, 30634);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1954_24754 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15689, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1954_24754_body (Current)).it_r;
