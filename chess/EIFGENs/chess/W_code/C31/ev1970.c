...
extern void F1970_25324(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1970_25325(EIF_REFERENCE);
extern void F1970_25326(EIF_REFERENCE);
extern void F1970_25327(EIF_REFERENCE);
static EIF_TYPED_VALUE F1970_25328_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1970_25328(EIF_REFERENCE);
extern void F1970_25329(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1970_25330(EIF_REFERENCE);
...
void F1970_25324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1969, Current, 0, 0, 31157);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 31157);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15684, 1968))(Current);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 19992, 0x04000000, 1); /* is_selected */
	*(EIF_BOOLEAN *)(Current + RTWA(19992, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_TYPED_VALUE F1970_25325 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(19992,Dtype(Current)));
	return r;
}


/* {EV_RADIO_MENU_ITEM_IMP}.disable_select */
void F1970_25326 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1969, Current, 0, 0, 31159);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 31159);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 19992, 0x04000000, 1); /* is_selected */
	*(EIF_BOOLEAN *)(Current + RTWA(19992, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F1970_25327 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1969, Current, 4, 0, 31153);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 31153);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	...
	if (tb1) {
		...
		for (;;) {
			...
			ui4_1 = ti4_1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(12552, "uncheck_item", loc3))(loc3, ui4_1x);
			RTHOOK(6);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(6,1);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(18127, "disable_select", tr1))(tr1);
			RTHOOK(7);
	...
	*(EIF_BOOLEAN *)(Current + RTWA(19992, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	...
	if (tb2) {
		...
		ui4_1 = ti4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(12551, "check_item", loc4))(loc4, ui4_1x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(12);
		RTCT("selected", EX_POST);
		tb2 = *(EIF_BOOLEAN *)(Current + RTWA(19992, dtype));
		if (tb2) {
			RTCK;
		} else {
			RTCF;
...
static EIF_TYPED_VALUE F1970_25328_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1969, Current, 0, 0, 31154);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 31154);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1970_25328 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15689, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1970_25328_body (Current)).it_r;
...
void F1970_25329 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1969, Current, 0, 0, 31155);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 31155);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1970_25330 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1969, Current, 0, 0, 31156);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 31156);
	RTIV(Current, RTAL);
	RTHOOK(1);
