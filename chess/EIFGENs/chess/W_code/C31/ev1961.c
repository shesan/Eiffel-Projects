...
extern void F1961_24942(EIF_REFERENCE);
extern void F1961_24943(EIF_REFERENCE);
extern void F1961_24944(EIF_REFERENCE);
extern void F1961_24945(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1961_24946(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1961_24947(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1961_24948(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1961_24949(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1961_24950(EIF_REFERENCE);
extern void F1961_24951(EIF_REFERENCE);
extern void F1961_24952(EIF_REFERENCE);
extern void F1961_24953(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1961_24954(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1961_24955_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1961_24955(EIF_REFERENCE);
...
void F1961_24942 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1960, Current, 0, 0, 30820);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30820);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1961_24943 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1960, Current, 2, 0, 30821);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30821);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	...
	if (tb1) {
		...
		if (EIF_TEST(loc1)) {
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(19864, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (((EIF_INTEGER_32) 20L) + (EIF_INTEGER_32) (ti4_1 / ((EIF_INTEGER_32) 2L)));
		} else {
			RTHOOK(4);
			...
			if (EIF_TEST(loc2)) {
				RTHOOK(5);
				RTDBGAA(Current, dtype, 19864, 0x10000000, 1); /* extra_width */
				ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(17796, "height", loc2))(loc2)).it_i4);
				*(EIF_INTEGER_32 *)(Current + RTWA(19864, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (((EIF_INTEGER_32) 20L) + (EIF_INTEGER_32) (ti4_1 / ((EIF_INTEGER_32) 2L)));
			} else {
				if (RTAL & CK_CHECK) {
					RTHOOK(6);
	...
	RTHOOK(7);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(19482, 1959))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(8);
	RTDBGLE;
...
void F1961_24944 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1960, Current, 2, 0, 30822);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30822);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(loc2 != NULL)) {
		...
		for (;;) {
			...
			RTNHOOK(6,1);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(19017, "set_unchecked", tr1))(tr1);
			RTHOOK(7);
...
void F1961_24945 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1960, Current, 0, 0, 30823);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30823);
	RTIV(Current, RTAL);
...
RTOID (F1961_24946)
EIF_TYPED_VALUE F1961_24946 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1961_24946);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1960, Current, 0, 0, 30824);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30824);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1961_24947 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1960, Current, 2, 3, 30825);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30825);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16246, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc2 = RTCCL(tr1);
...
void F1961_24948 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1960, Current, 0, 1, 30826);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30826);
	RTIV(Current, RTAL);
	RTHOOK(1);
	switch (arg1) {
		case 39L:
		case 40L:
			RTHOOK(2);
			ub1 = (EIF_BOOLEAN) 1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(19878, dtype))(Current, ub1x);
			break;
		case 37L:
		case 38L:
			RTHOOK(3);
		...
		default:
			RTHOOK(4);
			ui4_1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(19515, 1959))(Current, ui4_1x);
			break;
	}
	RTVI(Current, RTAL);
	RTRS;
...
void F1961_24949 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1960, Current, 4, 1, 30827);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30827);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(loc4 != NULL)) {
		...
		up2 = tp2;
		ub1 = arg1;
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(19877, dtype))(Current, up1x, up2x, ub1x)).it_p);
	...
	if ((EIF_BOOLEAN)(loc1 != loc2)) {
		...
		if ((EIF_BOOLEAN)(loc3 != NULL)) {
			RTHOOK(7);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(18491, "set_focus", loc3))(loc3);
		}
	}
	RTVI(Current, RTAL);
	RTRS;
...
EIF_TYPED_VALUE F1961_24950 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1960, Current, 0, 0, 30828);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30828);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
void F1961_24951 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1960, Current, 1, 0, 30829);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30829);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1961_24952 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1960, Current, 0, 0, 30830);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30830);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1961_24953 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1960, Current, 0, 1, 30831);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30831);
	RTCC(arg1, 1960, l_feature_name, 1, eif_new_type(1569, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	tr1 = RTCCL(tr2);
	*(EIF_REFERENCE *)(Current + RTWA(19484, dtype)) = RTRV(RTWCT(19484, dtype, Dftype(Current)), tr1);
	RTAR(Current, tr1);
	RTHOOK(3);
...
void F1961_24954 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1960, Current, 0, 2, 30832);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30832);
	RTCC(arg1, 1960, l_feature_name, 1, eif_new_type(1405, 0x01), 0x01);
	RTCC(arg2, 1960, l_feature_name, 2, eif_new_type(1499, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
static EIF_TYPED_VALUE F1961_24955_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1960, Current, 0, 0, 30819);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1960, Current, 30819);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1961_24955 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15689, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1961_24955_body (Current)).it_r;
