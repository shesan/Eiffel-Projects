...
extern void F1040_25560(EIF_REFERENCE, int);
...
void F1040_25560 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1039, Current, 0, 25559);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
