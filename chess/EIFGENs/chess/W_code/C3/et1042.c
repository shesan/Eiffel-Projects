...
extern EIF_TYPED_VALUE F1042_9991(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1042_9992(EIF_REFERENCE);
extern void F1042_9993(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1042_9994(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1042_9991 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1042_9992 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1041, Current, 1, 0, 16339);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1041, Current, 16339);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1042_9993 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1041, Current, 2, 1, 16340);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1041, Current, 16340);
	RTCC(arg1, 1041, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7774, 0xF800011C, 0); /* items */
	{
	...
	*(EIF_REFERENCE *)(Current + RTWA(7774, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7773, 0xF80000E8, 0); /* error_string */
	...
	*(EIF_REFERENCE *)(Current + RTWA(7773, dtype)) = (EIF_REFERENCE) tr1;
	...
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 7772, 0x04000000, 1); /* error */
...
void F1042_9994 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1041, Current, 1, 0, 16341);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
