...
extern EIF_TYPED_VALUE F1039_9981(EIF_REFERENCE);
extern void F1039_25560(EIF_REFERENCE, int);
...
/* {ETF_MODEL_ACCESS}.m */
RTOID (F1039_9981)
EIF_TYPED_VALUE F1039_9981 (EIF_REFERENCE Current)
{
	GTCX
...
void F1039_25560 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1038, Current, 0, 25559);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
