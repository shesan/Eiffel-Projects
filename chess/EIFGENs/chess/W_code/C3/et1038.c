...
extern void F1038_9977(EIF_REFERENCE);
extern void F1038_9978(EIF_REFERENCE);
extern void F1038_9979(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1038_9980(EIF_REFERENCE);
...
void F1038_9977 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTHOOK(4);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(14994, "launch", loc1))(loc1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
void F1038_9978 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7764, 0xF800064E, 0); /* main_window */
...
void F1038_9979 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(15242, "show", tr1))(tr1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
/* {ETF_GUI}.main_window */
EIF_TYPED_VALUE F1038_9980 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
