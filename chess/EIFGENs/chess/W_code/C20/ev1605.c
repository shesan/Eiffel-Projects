...
extern EIF_TYPED_VALUE F1605_18195(EIF_REFERENCE);
extern void F1605_18196(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1605_18195 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1605_18196 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1604, Current, 0, 0, 24863);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1604, Current, 24863);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14811, 0xF80006B7, 0); /* implementation */
