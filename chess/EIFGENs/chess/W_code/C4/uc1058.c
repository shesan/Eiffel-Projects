...
extern EIF_TYPED_VALUE F1058_10156(EIF_REFERENCE);
...
RTOID (F1058_10156)
EIF_TYPED_VALUE F1058_10156 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1057, Current, 0, 0, 16500);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1057, Current, 16500);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
