...
static const EIF_TYPE_INDEX egt_13_1204 [] = {0xFF01,1875,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1204 [] = {0xFF01,926,0xFF01,1875,0xFFFF};
...
static const struct desc_info desc_1204[] = {
	...
	{EIF_GENERIC(egt_13_1204), 18565, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 18566, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1204), 18567, 0xFFFFFFFF},
};
void Init1204(void)
{
	IDSC(desc_1204, 0, 1203);
	IDSC(desc_1204 + 1, 1, 1203);
	IDSC(desc_1204 + 32, 817, 1203);
}
