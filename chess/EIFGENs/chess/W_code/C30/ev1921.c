...
static EIF_TYPED_VALUE F1921_23711_body(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1921_23703 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(19423,Dtype(Current)));
	return r;
}


/* {EV_TOOL_BAR_ITEM_IMP}.interface */
static EIF_TYPED_VALUE F1921_23711_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1921_23711 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15689, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1921_23711_body (Current)).it_r;
