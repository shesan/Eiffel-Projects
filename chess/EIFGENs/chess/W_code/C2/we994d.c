...
static const EIF_TYPE_INDEX egt_16_994 [] = {0xFF01,1479,0xFFFF};
static const EIF_TYPE_INDEX egt_17_994 [] = {0xFF01,1412,0xFFFF};
...
static const struct desc_info desc_994[] = {
	...
	{EIF_GENERIC(egt_13_994), 15403, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_994), 15404, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_994), 15405, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_994), 15406, 0xFFFFFFFF},
	{EIF_GENERIC(egt_17_994), 15407, 0xFFFFFFFF},
};
void Init994(void)
{
	IDSC(desc_994, 0, 993);
	IDSC(desc_994 + 1, 1, 993);
	IDSC(desc_994 + 32, 1101, 993);
}
