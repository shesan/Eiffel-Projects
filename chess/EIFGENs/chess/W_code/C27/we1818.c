...
extern EIF_TYPED_VALUE F1818_20826(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1818_20826 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1817, Current, 0, 0, 26875);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1817, Current, 26875);
	RTIV(Current, RTAL);
	RTHOOK(1);
