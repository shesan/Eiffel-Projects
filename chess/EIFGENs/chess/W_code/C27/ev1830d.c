...
static const EIF_TYPE_INDEX egt_13_1830 [] = {0xFF01,51,0xFFFF};
...
static const struct desc_info desc_1830[] = {
	...
	{EIF_GENERIC(egt_13_1830), 1317, 0xFFFFFFFF},
	...
	{EIF_GENERIC(NULL), 0x00, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0197 /*203*/), 27134, 0},
...
void Init1830(void)
{
	...
	IDSC(desc_1830 + 32, 193, 1829);
	IDSC(desc_1830 + 65, 233, 1829);
	IDSC(desc_1830 + 66, 103, 1829);
	IDSC(desc_1830 + 91, 92, 1829);
	IDSC(desc_1830 + 93, 959, 1829);
}
