...
extern void F1280_13199(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1280_13200(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1280_13201(EIF_REFERENCE);
extern void F1280_25566(EIF_REFERENCE, int);
...
/* {EV_ID_IMP}.make_id */
void F1280_13199 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1279, Current, 0, 0, 19442);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1279, Current, 19442);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_ID_IMP}.id */
EIF_TYPED_VALUE F1280_13200 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(10886,Dtype(Current)));
	return r;
}
...
/* {EV_ID_IMP}.counter */
RTOID (F1280_13201)
EIF_TYPED_VALUE F1280_13201 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1279, Current, 0, 0, 19444);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1279, Current, 19444);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F1280_25566 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1279, Current, 0, 25565);
	RTSA(dtype);
	RTME(dtype, 0);
