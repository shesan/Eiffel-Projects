...
extern void F1702_19470(EIF_REFERENCE);
static EIF_TYPED_VALUE F1702_19472_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1702_19472(EIF_REFERENCE);
...
void F1702_19470 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1701, Current, 0, 0, 25923);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1701, Current, 25923);
	RTIV(Current, RTAL);
...
static EIF_TYPED_VALUE F1702_19472_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1701, Current, 0, 0, 25924);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1701, Current, 25924);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1702_19472 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15689, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1702_19472_body (Current)).it_r;
