...
extern EIF_TYPED_VALUE F1659_18742(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1659_18743(EIF_REFERENCE);
extern void F1659_25631(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1659_18742 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1658, Current, 1, 1, 25412);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1658, Current, 25412);
	RTCC(arg1, 1658, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		if (!RTEQ(tr1, arg1)) {
			ur1 = RTCCL(arg1);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(15221, "is_parent_recursive", loc1))(loc1, ur1x)).it_b);
			tb1 = tb2;
		}
...
EIF_TYPED_VALUE F1659_18743 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1659_25631 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1658, Current, 0, 25630);
	RTSA(dtype);
	RTME(dtype, 0);
