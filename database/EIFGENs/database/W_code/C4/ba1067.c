/*
 * Code for class BAD_DATABASE_COMMON_KEY_DB_RESULT_HAS_COMMON_KEY_MAPPINGS_FROM_CURRENT_DATABASE_AND_P_SECOND_ONLY_KEY_MATCH
 */
...
extern EIF_TYPED_VALUE F1067_7824(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {BAD_DATABASE_COMMON_KEY_DB_RESULT_HAS_COMMON_KEY_MAPPINGS_FROM_CURRENT_DATABASE_AND_P_SECOND_ONLY_KEY_MATCH}.common_key_db */
EIF_TYPED_VALUE F1067_7824 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1066, Current, 1, 1, 14122);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1066, Current, 14122);
	{
