/*
 * Code for class BAD_DATABASE_INTERVAL_IMAGE_VALUE_EXISTS_IN_RESULT_MEAN_MODEL_SHOULD_HAVE_IT
 */
...
extern EIF_TYPED_VALUE F1064_7821(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {BAD_DATABASE_INTERVAL_IMAGE_VALUE_EXISTS_IN_RESULT_MEAN_MODEL_SHOULD_HAVE_IT}.interval_image */
EIF_TYPED_VALUE F1064_7821 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1063, Current, 4, 2, 14119);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1063, Current, 14119);
	RTCC(arg1, 1063, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTCC(arg2, 1063, l_feature_name, 2, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
