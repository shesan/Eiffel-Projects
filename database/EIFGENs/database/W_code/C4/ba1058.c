/*
 * Code for class BAD_LINEAR_DB_INSERT_ENTRY_ADDED_NO_ADDITION
 */
...
extern void F1058_7813(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {BAD_LINEAR_DB_INSERT_ENTRY_ADDED_NO_ADDITION}.insert */
void F1058_7813 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1057, Current, 0, 2, 14111);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1057, Current, 14111);
	RTIV(Current, RTAL);
