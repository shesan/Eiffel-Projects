/*
 * Code for class BAD_DATABASE_INNER_JOIN_RESULT_EXISTS_IN_OTHER_DATABASE
 */
...
extern EIF_TYPED_VALUE F1061_7818(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {BAD_DATABASE_INNER_JOIN_RESULT_EXISTS_IN_OTHER_DATABASE}.inner_join */
EIF_TYPED_VALUE F1061_7818 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1060, Current, 9, 1, 14116);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1060, Current, 14116);
	{
