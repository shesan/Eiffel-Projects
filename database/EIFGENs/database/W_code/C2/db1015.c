/*
 * Code for class DBT_INNER_JOIN6
 */
...
extern void F1015_7480(EIF_REFERENCE);
extern void F1015_7481(EIF_REFERENCE);
extern void EIF_Minit1015(void);
extern EIF_REFERENCE _A1015_85();
...
/* {DBT_INNER_JOIN6}.make */
void F1015_7480 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1014, Current, 0, 0, 13763);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	tr1 = RTMS_EX_H("common_key_mapping_exists_in_result",35,541987188);
	ur1 = tr1;
	{
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1015_85, (EIF_POINTER)(0),5210, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F1015_7481 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_inner_join6";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1014, Current, 2, 0, 13764);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_inner_join6: POSTCONDITION, common_key_mapping_exists_in_result",67,1396581492);
	ur1 = tr1;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5115, dtype)) = (EIF_REFERENCE) tr1;
	...
	ur1 = tr1;
	tr2 = RTMS_EX_H("aaaaa",5,1634516833);
	ur2 = tr2;
	...
	ur1 = tr1;
	tr2 = RTMS_EX_H("ccccc",5,1668218211);
	ur2 = tr2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(5424, "insert", loc2))(loc2, ur1x, ur2x);
	RTHOOK(7);
	tr1 = RTMS_EX_H("b",1,98);
	ur1 = tr1;
	tr2 = RTMS_EX_H("bbbbb",5,1651367522);
	ur2 = tr2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(5424, "insert", loc2))(loc2, ur1x, ur2x);
	RTHOOK(8);
	tr1 = RTMS_EX_H("d",1,100);
	ur1 = tr1;
	tr2 = RTMS_EX_H("ddddd",5,1685068900);
	ur2 = tr2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(5424, "insert", loc2))(loc2, ur1x, ur2x);
	RTHOOK(9);
	tr1 = RTMS_EX_H("f",1,102);
	ur1 = tr1;
	tr2 = RTMS_EX_H("fffff",5,1718770278);
	ur2 = tr2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(5424, "insert", loc2))(loc2, ur1x, ur2x);
	RTHOOK(10);
	tr1 = RTMS_EX_H("e",1,101);
	ur1 = tr1;
	tr2 = RTMS_EX_H("eeeee",5,1701919589);
	ur2 = tr2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(5424, "insert", loc2))(loc2, ur1x, ur2x);
	RTHOOK(11);
