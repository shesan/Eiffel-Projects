...
extern void F1007_7464(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1007_7465(EIF_REFERENCE);
extern void EIF_Minit1007(void);
extern EIF_REFERENCE _A1007_85();
...
/* {DBT_ITERATOR8}.make */
void F1007_7464 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	
	{
		...
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1007_85, (EIF_POINTER)(0),5202, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1007_7465 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_iterator8";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1006, Current, 2, 0, 13748);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1006, Current, 13748);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_iterator8: TREE_DB, str_str, go through nothing",51,1672365671);
	ur1 = tr1;
