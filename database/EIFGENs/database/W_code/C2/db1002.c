...
extern void F1002_7411(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1002_7412(EIF_REFERENCE);
extern void EIF_Minit1002(void);
extern EIF_REFERENCE _A1002_85();
...
/* {DBT_MODEL6}.make */
void F1002_7411 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	
	{
		...
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1002_85, (EIF_POINTER)(0),5154, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1002_7412 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_model6";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1001, Current, 4, 0, 13695);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_model6: str TREE_DB, check if its model maps all the keys and values",72,633410419);
	ur1 = tr1;
