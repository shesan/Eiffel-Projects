...
extern void F994_7395(EIF_REFERENCE);
extern void F994_7396(EIF_REFERENCE);
extern void EIF_Minit994(void);
extern EIF_REFERENCE _A994_85();
...
/* {DBT_INSERT7}.make */
void F994_7395 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 993, Current, 0, 0, 13678);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(993, Current, 13678);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A994_85, (EIF_POINTER)(0),5146, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F994_7396 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_insert7";
	RTEX;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_insert7: POSTCONDITION, entry_added, insert wrong",53,1790579047);
	ur1 = tr1;
