...
extern void F1009_7468(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1009_7469(EIF_REFERENCE);
...
/* {DBT_ITERATOR6}.make */
void F1009_7468 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1008, Current, 0, 0, 13751);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1008, Current, 13751);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1009_85, (EIF_POINTER)(0),5204, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1009_7469 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_iterator6";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1008, Current, 4, 0, 13752);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1008, Current, 13752);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_iterator6: TREE_DB, int_str, go through 1 ~ 10, `a` ~ `j`",61,1605340512);
	ur1 = tr1;
