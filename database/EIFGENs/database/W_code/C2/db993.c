...
extern void F993_7393(EIF_REFERENCE);
extern void F993_7394(EIF_REFERENCE);
extern void EIF_Minit993(void);
extern EIF_REFERENCE _A993_85();
...
/* {DBT_INSERT8}.make */
void F993_7393 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 992, Current, 0, 0, 13676);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A993_85, (EIF_POINTER)(0),5145, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F993_7394 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_insert8";
	RTEX;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_insert8: POSTCONDITION, entry_added, insert nothing",55,1012762983);
	ur1 = tr1;
