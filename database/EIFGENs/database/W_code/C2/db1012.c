...
extern void F1012_7474(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1012_7475(EIF_REFERENCE);
extern void EIF_Minit1012(void);
extern EIF_REFERENCE _A1012_85();
...
/* {DBT_ITERATOR2}.make */
void F1012_7474 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1011, Current, 0, 0, 13757);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1011, Current, 13757);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1012_85, (EIF_POINTER)(0),5207, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1012_7475 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_iterator2";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1011, Current, 4, 0, 13758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1011, Current, 13758);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_iterator2: LINEAR_DB, int_str, go through 1 ~ 10, `a` ~ `j`",63,1463311712);
	ur1 = tr1;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,270,0xFF01,0xFFF9,2,186,218,0xFF01,232,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
	...
	*(EIF_INTEGER_32 *)tr1 = ti4_1;
	...
	for (;;) {
		...
		ui4_1 = ((EIF_INTEGER_32) 1L);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2556, "item", tr1))(tr1, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "item", loc4))(loc4)).it_i4);
		tr1 = RTLN(eif_new_type(218, 0x00).id);
		*(EIF_INTEGER_32 *)tr1 = ti4_1;
		if (RTEQ(tr2, tr1)) {
