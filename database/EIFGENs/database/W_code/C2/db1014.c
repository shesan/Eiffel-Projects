/*
 * Code for class DBT_INNER_JOIN7
 */
...
extern void F1014_7478(EIF_REFERENCE);
extern void F1014_7479(EIF_REFERENCE);
extern void EIF_Minit1014(void);
extern EIF_REFERENCE _A1014_85();
...
/* {DBT_INNER_JOIN7}.make */
void F1014_7478 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTHOOK(2);
	tr1 = RTMS_EX_H("result_exists_in_current_database",33,577069413);
	ur1 = tr1;
	{
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1014_85, (EIF_POINTER)(0),5209, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F1014_7479 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_inner_join7";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1013, Current, 2, 0, 13762);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1013, Current, 13762);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_inner_join7: POSTCONDITION, result_exists_in_current_database",65,486071909);
	ur1 = tr1;
