/*
 * Code for class DBT_INTERVAL_IMAGE4
 */
...
extern void F1020_7490(EIF_REFERENCE);
extern void F1020_7491(EIF_REFERENCE);
extern void EIF_Minit1020(void);
extern EIF_REFERENCE _A1020_85();
...
/* {DBT_INTERVAL_IMAGE4}.make */
void F1020_7490 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1019, Current, 0, 0, 13773);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1019, Current, 13773);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1020_85, (EIF_POINTER)(0),5215, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F1020_7491 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_interval_image4";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1019, Current, 1, 0, 13774);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1019, Current, 13774);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_interval_image4: POSTCONDITION, nothing_changed",51,74260068);
	ur1 = tr1;
