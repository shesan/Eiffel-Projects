/*
 * Code for class DBT_COMMON_KEY_DB7
 */
...
extern void F1023_7496(EIF_REFERENCE);
extern void F1023_7497(EIF_REFERENCE);
extern void EIF_Minit1023(void);
extern EIF_REFERENCE _A1023_85();
...
/* {DBT_COMMON_KEY_DB7}.make */
void F1023_7496 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1022, Current, 0, 0, 13779);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1022, Current, 13779);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1023_85, (EIF_POINTER)(0),5218, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F1023_7497 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_common_key_db_7";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1022, Current, 2, 0, 13780);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1022, Current, 13780);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_common_key_db_7: POSTCONDITION, result_has_common_key_mappings_from_current_database_and_p_second, only values match",120,1607039080);
	ur1 = tr1;
