...
extern void F1003_7413(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1003_7414(EIF_REFERENCE);
extern void EIF_Minit1003(void);
extern EIF_REFERENCE _A1003_85();
...
/* {DBT_MODEL4}.make */
void F1003_7413 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 13696);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 13696);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1003_85, (EIF_POINTER)(0),5155, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1003_7414 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_model4";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1002, Current, 4, 0, 13697);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 13697);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_model4: str LINEAR_DB, check if its keys and its values map to a model",74,368786540);
	ur1 = tr1;
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(6);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5436, "keys", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		...
		for (;;) {
			...
			loc3 = RTCCL(tr1);
			if (EIF_TEST(loc3)) {
				ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5537, "count", loc3))(loc3)).it_i4);
			...
			if (tb4) {
				ur1 = RTCCL(loc4);
				tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5539, "has", loc3))(loc3, ur1x)).it_b);
				tb3 = tb4;
			}
			tb1 = tb3;
			RTHOOK(8);
