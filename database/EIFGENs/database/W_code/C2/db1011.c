...
extern void F1011_7472(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1011_7473(EIF_REFERENCE);
extern void EIF_Minit1011(void);
extern EIF_REFERENCE _A1011_85();
...
/* {DBT_ITERATOR3}.make */
void F1011_7472 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	
	{
		...
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1011_85, (EIF_POINTER)(0),5206, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1011_7473 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_iterator3";
	RTEX;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1010, Current, 4, 0, 13756);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_iterator3: LINEAR_DB, str_str, go through `a` ~ `j`",55,2084305760);
	ur1 = tr1;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,270,0xFF01,0xFFF9,2,186,0xFF01,232,0xFF01,232,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
