...
extern void F995_7397(EIF_REFERENCE);
extern void F995_7398(EIF_REFERENCE);
extern void EIF_Minit995(void);
extern EIF_REFERENCE _A995_85();
...
/* {DBT_INSERT6}.make */
void F995_7397 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 13680);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 13680);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(5117, dtype))(Current);
	RTHOOK(2);
	tr1 = RTMS_EX_H("no_previous_entry",17,1484364921);
	ur1 = tr1;
	{
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A995_85, (EIF_POINTER)(0),5147, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F995_7398 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_insert6";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 13681);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 13681);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_insert6: PRECONDITION, no_previous_entry",44,1171413881);
	ur1 = tr1;
