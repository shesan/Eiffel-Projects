...
extern void F971_7349(EIF_REFERENCE);
...
/* {DBT_OVERRIDE8}.make */
void F971_7349 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A971_85, (EIF_POINTER)(0),5123, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
{
	GTCX
	char *l_feature_name = "dbt_override8";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13633);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_override8: POSTCONDITION, overriden_result, added wrong value",65,2120342373);
	ur1 = tr1;
