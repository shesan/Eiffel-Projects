...
extern void F974_7355(EIF_REFERENCE);
extern void F974_7356(EIF_REFERENCE);
extern void EIF_Minit974(void);
extern EIF_REFERENCE _A974_85();
...
/* {DBT_OVERRIDE5}.make */
void F974_7355 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 973, Current, 0, 0, 13638);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(973, Current, 13638);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(5117, dtype))(Current);
	RTHOOK(2);
	tr1 = RTMS_EX_H("overriden_result",16,284874356);
	ur1 = tr1;
	{
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A974_85, (EIF_POINTER)(0),5126, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F974_7356 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_override5";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 973, Current, 0, 0, 13639);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(973, Current, 13639);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_override5: POSTCONDITION, overriden_result, no override",59,1207602533);
	ur1 = tr1;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5115, dtype)) = (EIF_REFERENCE) tr1;
	...
	ur1 = tr2;
	tr3 = RTMS_EX_H("overriden_value",15,1997169765);
	ur2 = tr3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(5426, "override", tr1))(tr1, ur1x, ur2x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
