...
extern void F977_7361(EIF_REFERENCE);
extern void F977_7362(EIF_REFERENCE);
extern void EIF_Minit977(void);
extern EIF_REFERENCE _A977_85();
...
/* {DBT_HAS_KEY5}.make */
void F977_7361 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 976, Current, 0, 0, 13644);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A977_85, (EIF_POINTER)(0),5129, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
{
	GTCX
	char *l_feature_name = "dbt_has_key5";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 976, Current, 1, 0, 13645);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_has_key5: POSTCONDITION, key_exists, false positive: no key report true",75,98962533);
	ur1 = tr1;
