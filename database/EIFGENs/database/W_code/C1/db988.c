...
extern void F988_7383(EIF_REFERENCE);
extern void F988_7384(EIF_REFERENCE);
extern void EIF_Minit988(void);
extern EIF_REFERENCE _A988_85();
...
/* {DBT_SEARCH3}.make */
void F988_7383 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 987, Current, 0, 0, 13666);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A988_85, (EIF_POINTER)(0),5140, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F988_7384 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_search3";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 987, Current, 1, 0, 13667);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_search3: POSTCONDITION, nothing_changed",43,1935171428);
	ur1 = tr1;
