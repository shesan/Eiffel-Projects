...
extern void F990_7387(EIF_REFERENCE);
extern void F990_7388(EIF_REFERENCE);
...
/* {DBT_COUNT3}.make */
void F990_7387 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 989, Current, 0, 0, 13670);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 13670);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(5117, dtype))(Current);
	RTHOOK(2);
	tr1 = RTMS_EX_H("consistent_counts",17,454906483);
	ur1 = tr1;
	{
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A990_85, (EIF_POINTER)(0),5142, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F990_7388 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_count3";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 989, Current, 1, 0, 13671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 13671);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_count3: POSTCONDITION, consistent_counts",44,484005747);
	ur1 = tr1;
