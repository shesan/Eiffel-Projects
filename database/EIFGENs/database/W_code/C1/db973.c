...
extern void F973_7354(EIF_REFERENCE);
...
#define ur2 ur2x.it_r
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A973_85, (EIF_POINTER)(0),5125, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F973_7354 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_override6";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_override6: POSTCONDITION, overriden_result, no addition",59,178126446);
	ur1 = tr1;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5115, dtype)) = (EIF_REFERENCE) tr1;
	...
	ur1 = tr2;
	tr3 = RTMS_EX_H("added_value",11,1034984293);
	ur2 = tr3;
