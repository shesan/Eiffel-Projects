...
extern void F978_7363(EIF_REFERENCE);
extern void F978_7364(EIF_REFERENCE);
extern void EIF_Minit978(void);
extern EIF_REFERENCE _A978_85();
...
/* {DBT_HAS_KEY4}.make */
void F978_7363 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 977, Current, 0, 0, 13646);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	tr1 = RTMS_EX_H("key_exists",10,675446387);
	ur1 = tr1;
	{
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A978_85, (EIF_POINTER)(0),5130, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F978_7364 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_has_key4";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 977, Current, 2, 0, 13647);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_has_key4: POSTCONDITION, key_exists, false negative: existing key report false",82,1843425125);
	ur1 = tr1;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5115, dtype)) = (EIF_REFERENCE) tr1;
	...
	if (EIF_TEST(loc2)) {
		...
		ur2 = tr2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(5439, "debug_insert", loc2))(loc2, ur1x, ur2x);
	}
	RTHOOK(5);
