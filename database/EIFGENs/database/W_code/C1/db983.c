...
extern void F983_7373(EIF_REFERENCE);
extern void F983_7374(EIF_REFERENCE);
extern void EIF_Minit983(void);
extern EIF_REFERENCE _A983_85();
...
/* {DBT_DELETE5}.make */
void F983_7373 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A983_85, (EIF_POINTER)(0),5135, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F983_7374 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_delete5";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13657);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_delete5: POSTCONDITION, entry_deleted, delete other",55,276356210);
	ur1 = tr1;
