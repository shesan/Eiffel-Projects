...
extern void F969_7345(EIF_REFERENCE);
extern void F969_7346(EIF_REFERENCE);
extern void EIF_Minit969(void);
extern EIF_REFERENCE _A969_85();
...
/* {DBT_OVERRIDE10}.make */
void F969_7345 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A969_85, (EIF_POINTER)(0),5121, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F969_7346 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_override10";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_override10: POSTCONDITION, overriden_result, add then change \'b\'",68,1784493351);
	ur1 = tr1;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5115, dtype)) = (EIF_REFERENCE) tr1;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5115, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
	tr2 = RTMS_EX_H("z",1,122);
	ur1 = tr2;
	tr3 = RTMS_EX_H("zebra",5,1701887585);
	ur2 = tr3;
