...
extern void F970_7347(EIF_REFERENCE);
...
/* {DBT_OVERRIDE9}.make */
void F970_7347 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A970_85, (EIF_POINTER)(0),5122, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
{
	GTCX
	char *l_feature_name = "dbt_override9";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_override9: POSTCONDITION, overriden_result, override then change \'b\'",72,1795733031);
	ur1 = tr1;
