...
extern void F982_7371(EIF_REFERENCE);
extern void F982_7372(EIF_REFERENCE);
extern void EIF_Minit982(void);
extern EIF_REFERENCE _A982_85();
...
/* {DBT_DELETE6}.make */
void F982_7371 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A982_85, (EIF_POINTER)(0),5134, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F982_7372 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_delete6";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 13655);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_delete6: POSTCONDITION, entry_deleted, delete correct",57,1605527924);
	ur1 = tr1;
