...
extern void F987_7381(EIF_REFERENCE);
extern void F987_7382(EIF_REFERENCE);
extern void EIF_Minit987(void);
extern EIF_REFERENCE _A987_85();
...
/* {DBT_SEARCH4}.make */
void F987_7381 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 13664);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	tr1 = RTMS_EX_H("case_of_key_found",17,1288650596);
	ur1 = tr1;
	{
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A987_85, (EIF_POINTER)(0),5139, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F987_7382 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_search4";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 986, Current, 1, 0, 13665);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_search4: POSTCONDITION, case_of_key_found",45,316709732);
	ur1 = tr1;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5115, dtype)) = (EIF_REFERENCE) tr1;
	...
	ur1 = tr2;
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5423, "search", tr1))(tr1, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
