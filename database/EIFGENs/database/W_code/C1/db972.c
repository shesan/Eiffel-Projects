...
extern void F972_7351(EIF_REFERENCE);
extern void F972_7352(EIF_REFERENCE);
...
/* {DBT_OVERRIDE7}.make */
void F972_7351 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A972_85, (EIF_POINTER)(0),5124, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F972_7352 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_override7";
	RTEX;
...
#define ur2 ur2x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_override7: POSTCONDITION, overriden_result, overriden wrong value",69,1087607909);
	ur1 = tr1;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5115, dtype)) = (EIF_REFERENCE) tr1;
	...
	ur1 = tr2;
	tr3 = RTMS_EX_H("apple",5,1887160933);
	ur2 = tr3;
