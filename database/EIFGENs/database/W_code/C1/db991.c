...
extern void F991_7389(EIF_REFERENCE);
extern void F991_7390(EIF_REFERENCE);
extern void EIF_Minit991(void);
extern EIF_REFERENCE _A991_85();
...
/* {DBT_COUNT2}.make */
void F991_7389 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 13672);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 13672);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A991_85, (EIF_POINTER)(0),5143, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
...
void F991_7390 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "dbt_count2";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 990, Current, 1, 0, 13673);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 13673);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("dbt_count2: POSTCONDITION, nothing_changed",42,742138724);
	ur1 = tr1;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5115, dtype)) = (EIF_REFERENCE) tr1;
	...
	loc1 = (EIF_BOOLEAN) (EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 10L));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
