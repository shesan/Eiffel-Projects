/*
 * Code for class BAD_DATABASE_OVERRIDE_OVERRIDEN_RESULT_WRONG_VALUE
 */
...
extern void F1048_7801(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {BAD_DATABASE_OVERRIDE_OVERRIDEN_RESULT_WRONG_VALUE}.override */
void F1048_7801 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1047, Current, 0, 2, 14099);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1047, Current, 14099);
	...
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	tr3 = RTMS_EX_H("WRONGRESULT",11,834817620);
	ur2 = tr3;
