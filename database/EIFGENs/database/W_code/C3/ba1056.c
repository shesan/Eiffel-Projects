/*
 * Code for class BAD_LINEAR_DB_INSERT_ENTRY_ADDED_CHANGE_OTHERS
 */
...
extern void F1056_7811(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {BAD_LINEAR_DB_INSERT_ENTRY_ADDED_CHANGE_OTHERS}.insert */
void F1056_7811 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1055, Current, 2, 2, 14109);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 14109);
	RTIV(Current, RTAL);
...
body:;
	...
	tr3 = RTLNSMART(RTWCT(5436, dtype, dftype).id);
