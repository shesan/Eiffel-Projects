/*
 * Code for class BAD_DATABASE_OVERRIDE_OVERRIDEN_RESULT_NOTHING_DONE
 */
...
extern void F1049_7802(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {BAD_DATABASE_OVERRIDE_OVERRIDEN_RESULT_NOTHING_DONE}.override */
void F1049_7802 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1048, Current, 0, 2, 14100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1048, Current, 14100);
