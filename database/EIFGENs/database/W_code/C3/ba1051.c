/*
 * Code for class BAD_LINEAR_DB_DELETE_ENTRY_DELETED_CORRECT_DELETE_BUT_ADD_ANOTHER
 */
...
extern void F1051_7805(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1051_7806(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {BAD_LINEAR_DB_DELETE_ENTRY_DELETED_CORRECT_DELETE_BUT_ADD_ANOTHER}.insert */
void F1051_7805 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1050, Current, 0, 2, 14103);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1050, Current, 14103);
...
/* {BAD_LINEAR_DB_DELETE_ENTRY_DELETED_CORRECT_DELETE_BUT_ADD_ANOTHER}.delete */
void F1051_7806 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1050, Current, 2, 1, 14104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1050, Current, 14104);
	RTCC(arg1, 1050, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5436, dtype)) = (EIF_REFERENCE) tr3;
	...
	RTHOOK(9);
	tr3 = RTMS_EX_H("ZZZZ",4,1515870810);
	ur1 = tr3;
	tr4 = RTMS_EX_H("ZZZZ",4,1515870810);
	ur2 = tr4;
