...
extern EIF_TYPED_VALUE F1036_7611(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1036_7611 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1035, Current, 0, 0, 13877);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1035, Current, 13877);
	RTIV(Current, RTAL);
	RTHOOK(1);
