/*
 * Code for class BAD_LINEAR_DB_COUNT_CONSISTENT_COUNTS
 */
...
extern EIF_TYPED_VALUE F1055_7810(EIF_REFERENCE);
...
/* {BAD_LINEAR_DB_COUNT_CONSISTENT_COUNTS}.count */
EIF_TYPED_VALUE F1055_7810 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1054, Current, 0, 0, 14108);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1054, Current, 14108);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
	...
	Result = (EIF_INTEGER_32) ((EIF_INTEGER_32) -999L);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
