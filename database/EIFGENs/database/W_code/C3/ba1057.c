/*
 * Code for class BAD_LINEAR_DB_INSERT_ENTRY_ADDED_WRONG_ADDITION
 */
...
extern void F1057_7812(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {BAD_LINEAR_DB_INSERT_ENTRY_ADDED_WRONG_ADDITION}.insert */
void F1057_7812 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1056, Current, 0, 2, 14110);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1056, Current, 14110);
	RTIV(Current, RTAL);
...
body:;
	...
	RTNHOOK(2,1);
	ui4_1 = (EIF_INTEGER_32) (arg1 + ((EIF_INTEGER_32) 99L));
	...
	RTNHOOK(3,1);
	ui4_1 = arg2;
	ui4_2 = (EIF_INTEGER_32) (arg1 + ((EIF_INTEGER_32) 99L));
